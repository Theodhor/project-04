          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="field">
              ...
              <div className="control">
                <input className={`input ${this.state.error ? 'is-danger' : ''} `} name="name" placeholder="surname" onChange={this.handleChange} />
              </div>
            </div>
            <div className="field">
              <label className="label">Surname</label>
              <div className="control">
                <input className={`input ${this.state.error ? 'is-danger' : ''} `} name="surname" placeholder="Surname" onChange={this.handleChange} />
              </div>
            </div>
            <div className="field">
